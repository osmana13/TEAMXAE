...
public void dosomethingwithbuttonA(float theValueA) {
  println("button A = "+theValueA+"");  
...
void draw() {
  ...
  //image(img,0,0);
  //img.loadPixels();
  rect(Pitch*width, Roll*width, Yaw*width, 20, 20);
  fill(255,200,200);
  arc(Pitch*width, 479, 300, 280, 280, 100, 100, PI, TWO_PI);
}
